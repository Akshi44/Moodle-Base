  ...
  return (
    <div className='moodle-container'>
        <div class="col-md-12 mb-30">
            ...
            <p>Some tutorials for using Moodle can be found at&nbsp;<a href="http://docs.moodle.org/en/Getting_started_for_teachers" style={{textDecoration:'none',color:'#102DA2',fontWeight:'bold'}}>http://docs.moodle.org/en/Getting_started_for_teachers</a> and&nbsp;<a class="text-theme-colored2" href="http://docs.moodle.org/en/Student_tutorials" style={{textDecoration:'none',color:'#102DA2 ',fontWeight:'bold'}}>http://docs.moodle.org/en/Student_tutorials</a>.</p>
        </div>
    </div>
  )
}
